...
public class MovieTestData {
    ...
    public static final Movie WISH_MOVIE_1 = Movie.createWithWishlistType(MOVIE_TMDB_TO_1);
    public static final Movie WISH_MOVIE_2 = Movie.createWithWishlistType(MOVIE_TMDB_TO_2);
    public static final Movie WISH_MOVIE_3 = Movie.createWithWishlistType(MOVIE_TMDB_TO_3);
